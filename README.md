...
Neurome's architecture maps directly onto the human memory system. Each package name is borrowed from neuroscience and preserves the same functional role.

| Brain Structure                                   | Biological Role                                                                                                                                                                                                                                                                      | Neurome Package                                | Role in Neurome                                                                                                                                       |
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| Working memory (prefrontal cortex)                | Functional system — not a discrete structure — supported primarily by the dorsolateral prefrontal cortex; temporary, capacity-limited buffer for active cognitive processing                                                                                                         | [`@neurome/stm`](./nuclei/stm)                 | Engram-scoped observation buffer; discarded unless promoted                                                                                           |
| Amygdala                                          | Modulates encoding strength for emotionally salient or arousing stimuli; enhances hippocampal consolidation of high-arousal events via noradrenergic and glucocorticoid pathways — not a general-purpose salience filter                                                             | [`@neurome/amygdala`](./nuclei/amygdala)       | LLM-scores STM observations for importance; generalises the amygdala's role beyond emotional salience to semantic relevance                           |
| Long-term memory (hippocampal-neocortical system) | Functional category — not a discrete structure — spanning declarative memory (hippocampus + neocortex), procedural memory (basal ganglia, cerebellum), and priming (neocortex)                                                                                                       | [`@neurome/ltm`](./nuclei/ltm)                 | Persistent store of episodic records and distilled semantic memories with vector embeddings                                                           |
| Hippocampus                                       | Binds episodic memories and supports their gradual consolidation into cortical long-term storage; performs pattern separation (distinguishing similar episodes) and pattern completion (retrieving from partial cues); semantic knowledge eventually becomes hippocampus-independent | [`@neurome/hippocampus`](./nuclei/hippocampus) | Clusters episodic LTM records and distils them into semantic memories; maps to the hippocampal-neocortical dialogue rather than the hippocampus alone |
| Perirhinal cortex                                 | Supports familiarity-based recognition memory and disambiguation of perceptually or conceptually similar stimuli; sits at the interface of the ventral visual stream and the medial temporal lobe memory system                                                                      | [`@neurome/perirhinal`](./nuclei/perirhinal)   | Extracts and deduplicates named entities from observations                                                                                            |
| Prefrontal cortex                                 | Executive hub responsible for coordinating cognitive subsystems, planning, and working memory maintenance; "cortex" alone refers to the entire heterogeneous cortical sheet — coordination is specifically a prefrontal function                                                     | [`@neurome/cortex`](./synapses/cortex)         | Server process that hosts all memory subsystems and exposes them over a Unix socket                                                                   |
| Axon                                              | Transmits signals from a neuron's soma to downstream targets via the axon terminal                                                                                                                                                                                                   | [`@neurome/axon`](./nuclei/axon)               | IPC client that carries requests from the agent process to the cortex server                                                                          |
| Dendrite                                          | Receives and integrates synaptic inputs from upstream neurons on the postsynaptic side; does not route signals — routing is a software abstraction layered on the receive analogy                                                                                                    | [`@neurome/dendrite`](./synapses/dendrite)     | MCP server that receives LLM tool calls and routes them into memory operations                                                                        |
| Afferent nerves                                   | Sensory fibres that carry signals toward the central nervous system (centripetal direction)                                                                                                                                                                                          | [`@neurome/afferent`](./synapses/afferent)     | Fire-and-forget bridge that carries raw observations from the agent into the cortex                                                                   |
| Engram                                            | Sparse population of neurons whose activity encodes a specific memory; reactivation of the engram cell ensemble is necessary and sufficient for memory recall (experimentally confirmed via optogenetics)                                                                            | `engramId` (SDK concept)                       | Identifier scoping all memories to a single agent session or persistent identity                                                                      |
| Synapse                                           | Junction between neurons; the connection layer of the nervous system                                                                                                                                                                                                                 | `synapses/` (directory)                        | Integration adapters that wire Neurome into external systems (SDK, MCP, IPC)                                                                          |
